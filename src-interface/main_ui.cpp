    ...
    void renderMainUI()
    {
        ...
        // else
        {
            ...
            if (ImGui::BeginTabBar("Main TabBar", ImGuiTabBarFlags_None))
            {
                ...
                if (ImGui::BeginTabItem("记录器", nullptr, open_recorder ? ImGuiTabItemFlags_SetSelected : ImGuiTabItemFlags_None))
                {
                    open_recorder = false;
                    recorder_app->draw();
                    ImGui::EndTabItem();
                }
                if (ImGui::BeginTabItem("查看器"))
                {
                    viewer_app->draw();
                    ImGui::EndTabItem();
                }
